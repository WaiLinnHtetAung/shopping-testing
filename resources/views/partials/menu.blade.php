<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{route('products#dashboard','date')}}">
                <i class="fa-solid fa-clipboard-list c-sidebar-nav-icon"></i>
                </i>
                Product List
            </a>
        </li>
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{route('order#list')}}">
                <i class="fa-solid fa-people-group c-sidebar-nav-icon"></i></i>
                </i>
                Order List
            </a>
        </li>
